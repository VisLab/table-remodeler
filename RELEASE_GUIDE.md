...
- `dist/table_remodeler-0.9.0-py3-none-any.whl` (wheel distribution)
- `dist/table_remodeler-0.9.0.tar.gz` (source distribution)
...
python -m zipfile -l dist/table_remodeler-0.9.0-py3-none-any.whl

# Check the source distribution (requires tar in PATH)
tar -tzf dist/table_remodeler-0.9.0.tar.gz
```
...
```bash
# List contents of the wheel
unzip -l dist/table_remodeler-0.9.0-py3-none-any.whl
...
pip install dist/table_remodeler-0.9.0-py3-none-any.whl
```
...
Expected output: `Checking dist/table_remodeler-0.9.0.tar.gz: PASSED` (and same for .whl)
...
```bash
pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ table-remodeler==0.9.0
```
...
Go to: https://github.com/hed-standard/table-remodeler/releases/tag/0.9.0

#### 8.2 Edit release and attach files

- Click **Edit release**
- Drag and drop or upload:
  - `dist/table_remodeler-0.9.0-py3-none-any.whl`
  - `dist/table_remodeler-0.9.0.tar.gz`
