...
- [Merge consecutive](#merge-consecutive) - Merge consecutive identical events
- [Remap columns](#remap-columns) - Map column value combinations to new columns
- [Remove columns](#remove-columns) - Remove specified columns
- [Remove rows](#remove-rows) - Remove rows based on column values
- [Rename columns](#rename-columns) - Rename columns
...
- [Summarize HED tags](#summarize-hed-tags) - Summarize HED tag usage
- [Summarize HED type](#summarize-hed-type) - Summarize HED type tag details
